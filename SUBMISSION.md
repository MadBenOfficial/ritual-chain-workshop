...
Required Track (Commit-Reveal) implemented on top of the workshop starter.
The updated contract is `hardhat/contracts/AIJudge.sol`; tests are in
`hardhat/contracts/AIJudge.t.sol`.
